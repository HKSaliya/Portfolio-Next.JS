...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative rounded-xl overflow-hidden group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-white justify-between flex flex-col space-y-4",
        className
      )}
      style={{
        background: 'rgb(2,0,36)',
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(36,41,59,1) 75%)'
      }}
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full  `} >
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-50 flex items-cente justify-center text-white font-bold" />
          </BackgroundGradientAnimation>
        )}
            ...
            id === 3 && (
              <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2" >
                <div className="flex flex-col gap-3 lg:gap-8" >
                  ...
                  <span className="py-2 lg:py-1 lg:px-3 px-3 rounded-lg bg-[#10132E] text-center" > </span>
                </div>
                <div className="flex flex-col gap-3 lg:gap-8" >
                <span className="py-2 lg:py-1 lg:px-3 px-3 rounded-lg bg-[#10132E] text-center" ></span>
